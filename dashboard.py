...
col1.subheader('Grades (1st Semester)')
fig = px.box(
    df,
    x='Status',
...
col2.subheader('Grades (2nd Semester)')
fig = px.box(
    df,
    x='Status',
...
col1.subheader('Distribution of Gender')
fig = px.histogram(
    df,
    x='Gender',
    color='Status',
...
col2.subheader('Distribution of Age at Enrollment')
fig = px.histogram(
    df,
    x='Age_at_enrollment',
    nbins=20,
...
col3.subheader('Tuition Fees Up to Date')
fig = px.histogram(
    df,
